...
public class Visite
{
    ...
    public long getVisite_date() {
        return visite_date;
    }

    public void setVisite_date(Date visite_date) {
        this.visite_date = visite_date.getTime();
    }
    ...
    public void setVisite_heure(Time visite_heure) {
        this.visite_heure = visite_heure.getTime();
    }
